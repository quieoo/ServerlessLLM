...
# python benchmark_trace.py --target_cv 1 --sllm_model_config_file_path ../mock_allocation/configs/L40-large.json --target_req_file_path ./outputs/L40-large-rr-alive-1-hour-2.txt --mapping round_robin --hour 24 --rate_scale_factor 0.4  --keep_alive 1

# cd ../../evaluation

BinaryPath="../tools/mock_allocation/build/Allocateion"
CONFIG_PATH="../tools/mock_allocation/configs/L40-large.json"
REQ_PATH="../tools/trace/outputs/L40-large-rr-alive-"
