...
/home/sdu/.conda/envs/sllm-worker/bin/python \
  ...
  --output evaluation/tensor_simulator/results/group-boundary-model0.json
```
...
/home/sdu/.conda/envs/sllm-worker/bin/python \
  ...
  --profiles \
    evaluation/tensor_simulator/results/group-boundary-model0.json \
    evaluation/tensor_simulator/results/group-boundary-model1.json \
    evaluation/tensor_simulator/results/group-boundary-model2.json \
    evaluation/tensor_simulator/results/group-boundary-model3.json \
    evaluation/tensor_simulator/results/group-boundary-model4.json \
    evaluation/tensor_simulator/results/group-boundary-model5.json \
    evaluation/tensor_simulator/results/group-boundary-model6.json \
    evaluation/tensor_simulator/results/group-boundary-model7.json \
  --h2d-gbps 24.56 \
...
/home/sdu/.conda/envs/sllm-worker/bin/python \
  ...
  --output \
    evaluation/tensor_simulator/results/runtime-group-lru-cache-route-1000-2gpu.json
```
...
/home/sdu/.conda/envs/sllm-worker/bin/python \
  ...
  --output \
    evaluation/tensor_simulator/results/prefix-mckp-lookahead-k32-route-1000-2gpu.json
```
...
python3 tools/layerpipe/analyze_prefix_mckp_trace_effects.py \
  ...
  --tensor-layout evaluation/tensor_simulator/results/tensor-layout.json \
  --output-json \
    evaluation/tensor_simulator/results/prefix-mckp-trace-effects.json \
  --output-csv \
    evaluation/tensor_simulator/results/prefix-mckp-trace-effects.csv \
  --output-svg \
    evaluation/tensor_simulator/results/prefix-mckp-trace-effects.svg
```
...
```text
evaluation/tensor_simulator/results/trace-variant-round-robin-lru.json
evaluation/tensor_simulator/results/trace-variant-round-robin-mckp.json
evaluation/tensor_simulator/results/trace-variant-round-robin-effects.{json,csv,svg}
```
...
/home/sdu/.conda/envs/sllm-worker/bin/python \
  ...
  --mckp \
    evaluation/tensor_simulator/results/prefix-mckp-lookahead-k32-route-1000-2gpu.json \
  --output \
    evaluation/tensor_simulator/results/prefix-mckp-vs-lru-ttft-cdf.svg
```
