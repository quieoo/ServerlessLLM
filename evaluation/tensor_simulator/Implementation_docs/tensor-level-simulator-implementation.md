...
- `evaluation/tensor_simulator/export_layerweave_tensor_layout.py`
...
- `evaluation/tensor_simulator/test_layerweave_tensor_pipeline_sim.py`
  - CPU-only backend 不变量测试。
- `evaluation/tensor_simulator/profile_layerweave_tensor_compute.py`
...
python evaluation/tensor_simulator/test_layerweave_tensor_pipeline_sim.py
```
...
```bash
python evaluation/tensor_simulator/export_layerweave_tensor_layout.py \
  --config configs/servegen_8_models_layerpipe_l40_pool42.json \
  --output evaluation/tensor_simulator/results/tensor-layout.json
```
...
```bash
python evaluation/tensor_simulator/layerweave_tensor_pipeline_sim.py \
...
/home/sdu/.conda/envs/sllm-worker/bin/python \
  ...
  --max-unique-shapes 8 \
  --output \
    evaluation/tensor_simulator/results/tensor-compute-gpu0-model0-smoke.json
```
...
evaluation/tensor_simulator/results/tensor-compute-gpu0-model0-smoke.json
evaluation/tensor_simulator/results/gpu-profile-integration-smoke.json
evaluation/tensor_simulator/results/validation30-segment.json
evaluation/tensor_simulator/results/validation30-tensor-page.json
evaluation/tensor_simulator/results/validation30-compact-page.json
evaluation/tensor_simulator/results/sweep-*.json
```
...
```text
evaluation/tensor_simulator/results/group-validation30-segment-group0.json
evaluation/tensor_simulator/results/group-validation30-segment-group64.json
evaluation/tensor_simulator/results/group-validation30-segment-group64-pipeline.json
evaluation/tensor_simulator/results/group-validation30-segment-group64-pipeline-route.json
evaluation/tensor_simulator/results/group-validation30-tensor-page-group0.json
evaluation/tensor_simulator/results/group-validation30-tensor-page-group64.json
evaluation/tensor_simulator/results/group-validation30-tensor-page-group64-pipeline.json
evaluation/tensor_simulator/results/group-validation30-tensor-page-group64-pipeline-route.json
evaluation/tensor_simulator/results/group-smoke-compact-page.json
```
...
python evaluation/tensor_simulator/layerweave_tensor_pipeline_sim.py \
  ...
  --routing-policy exposed-stall \
  --output \
    evaluation/tensor_simulator/results/segment-group64-1000-frequency.json
```
...
--routing-replay \
  evaluation/tensor_simulator/results/segment-group64-1000-frequency.json
--output \
  evaluation/tensor_simulator/results/segment-group64-1000-pipeline-matched.json
```

Adaptive pipeline-value 不传 `--routing-replay`，输出：

```text
evaluation/tensor_simulator/results/segment-group64-1000-pipeline-adaptive.json
```
...
python evaluation/tensor_simulator/layerweave_tensor_pipeline_sim.py \
  ...
  --routing-policy exposed-stall \
  --output \
    evaluation/tensor_simulator/results/segment-group64-1000-1gpu-frequency.json
```
...
--replacement-policy pipeline-value
--output \
  evaluation/tensor_simulator/results/segment-group64-1000-1gpu-pipeline.json
```
...
```text
evaluation/tensor_simulator/results/compact-page64-group64-1000-1gpu-frequency.json
evaluation/tensor_simulator/results/compact-page64-group64-1000-1gpu-pipeline.json
```
...
```text
evaluation/tensor_simulator/results/segment-group64-1000-1gpu-frequency.json
evaluation/tensor_simulator/results/segment-group64-1000-1gpu-protected-pipeline.json
evaluation/tensor_simulator/results/segment-group64-1000-1gpu-protected-pipeline-shadow.json
```
...
python evaluation/tensor_simulator/layerweave_tensor_pipeline_sim.py \
  ...
  --routing-policy exposed-stall \
  --output \
    evaluation/tensor_simulator/results/compact-page64-group64-1000-1gpu-suffix-first-lru.json
```
...
evaluation/tensor_simulator/tensor_sim_segment_backend.py
    447 lines
    legacy Segment
...
```text
evaluation/tensor_simulator/results/segment-unified-group64-1000-frequency-lru.json
evaluation/tensor_simulator/results/segment-unified-group64-1000-frequency-lru-suffix-first.json
evaluation/tensor_simulator/results/segment-unified-group64-1000-pipeline-value.json
evaluation/tensor_simulator/results/segment-unified-group64-1000-protected-pipeline.json
evaluation/tensor_simulator/results/segment-unified-group64-1000-protected-pipeline-shadow.json
evaluation/tensor_simulator/results/segment-unified-group64-1000-suffix-breakdown-{000..110}.json
```
...
```text
evaluation/tensor_simulator/results/segment-unified-group64-balanced_iid-frequency-lru.json
evaluation/tensor_simulator/results/segment-unified-group64-balanced_iid-frequency-lru-suffix-first.json
evaluation/tensor_simulator/results/segment-unified-group64-round_robin-frequency-lru.json
evaluation/tensor_simulator/results/segment-unified-group64-round_robin-frequency-lru-suffix-first.json
evaluation/tensor_simulator/results/segment-unified-group64-phase_shift-frequency-lru.json
evaluation/tensor_simulator/results/segment-unified-group64-phase_shift-frequency-lru-suffix-first.json
evaluation/tensor_simulator/results/segment-unified-group64-working_set_shift-frequency-lru.json
evaluation/tensor_simulator/results/segment-unified-group64-working_set_shift-frequency-lru-suffix-first.json
```
...
python evaluation/tensor_simulator/layerweave_tensor_pipeline_sim.py \
  ...
  --routing-policy exposed-stall \
  --output \
    evaluation/tensor_simulator/results/segment-group64-1000-2gpu-lru.json
```
...
python evaluation/tensor_simulator/layerweave_tensor_pipeline_sim.py \
  ...
  --routing-replay \
    evaluation/tensor_simulator/results/segment-group64-1000-2gpu-lru.json \
  --output \
    evaluation/tensor_simulator/results/segment-group64-1000-2gpu-pipeline-matched-lru.json
```
