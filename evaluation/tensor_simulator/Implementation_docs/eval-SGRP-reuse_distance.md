...
MAX_PARALLEL=4 bash evaluation/tensor_simulator/experiments/run_eval_sgrp_reuse_distance.sh
```

汇总：

```bash
python evaluation/tensor_simulator/experiments/summarize_sgrp_reuse_distance.py \
...
```bash
bash evaluation/tensor_simulator/experiments/run_eval_sgrp_reuse_distance_fast200_2d.sh

python evaluation/tensor_simulator/experiments/summarize_sgrp_reuse_distance_2d.py \
...
bash evaluation/tensor_simulator/experiments/run_eval_sgrp_size_hotness_fast200.sh
```
