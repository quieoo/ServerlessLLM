...
````bash
# 单GPU
GPU_NUM=1 /mnt/n0/Tangram/Tangram/docs/1-overall.sh

MAX_REQUESTS=1000 GPU_NUM=1 GPU_POOL_SIZE=43 /mnt/n0/Tangram/Tangram/docs/1-overall.sh

MAX_REQUESTS=100 GPU_NUM=1 GPU_POOL_SIZE=43 /mnt/n0/Tangram/Tangram/docs/1-overall.sh
MAX_REQUESTS=100 GPU_NUM=2 GPU_POOL_SIZE=43 /mnt/n0/Tangram/Tangram/docs/1-overall.sh
MAX_REQUESTS=100 GPU_NUM=4 GPU_POOL_SIZE=43 /mnt/n0/Tangram/Tangram/docs/1-overall.sh
````
```
================ Model Load Summary ================
...
MAX_REQUESTS=100 GPU_NUM=1 GPU_POOL_SIZE=43 /mnt/n0/Tangram/Tangram/docs/1-overall.sh
MAX_REQUESTS=100 GPU_NUM=2 GPU_POOL_SIZE=43 /mnt/n0/Tangram/Tangram/docs/1-overall.sh
MAX_REQUESTS=100 GPU_NUM=3 GPU_POOL_SIZE=43 /mnt/n0/Tangram/Tangram/docs/1-overall.sh
...
' > /mnt/n0/Tangram/Tangram/docs/microbench_um_prefetch_100.log 2>&1 &
...
' >> /mnt/n0/Tangram/Tangram/docs/microbench_um_prefetch_100.1.log 2>&1 &
````
...
' > /mnt/n0/Tangram/Tangram/docs/microbench_memory_coalescing.log 2>&1 &
