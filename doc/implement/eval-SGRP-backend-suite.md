...
```bash
python doc/implement/run_sgrp_backend_workload_suite.py \
  --output-dir doc/results/sgrp-backend-suite-r1000-seed1236 \
  --requests 1000 --max-parallel 18

python tools/layerpipe/summarize_sgrp_backend_workload_suite.py \
...
```text
doc/implement/run_sgrp_backend_page_size_sweep.py
tools/layerpipe/summarize_sgrp_backend_page_size_sweep.py
...
doc/implement/run_sgrp_backend_pressure_sweep.py
tools/layerpipe/summarize_sgrp_backend_pressure_sweep.py
